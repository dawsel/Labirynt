...
namespace Labirynt
{
    ...
    class TEST :Gra
    {
        ...
        string[,] Map3 =
       {
        ...
        /// <summary>
        /// Gra o wymiarach 1295,1024 i tytule Labirynt Demo
        /// </summary>
        public TEST(): base(new Vector2(1295,1024),"Labirynt Demo") { }

        /// <summary>
        /// Wczytanie odpowiedzniej mapy na podstawie biezacego poziomu
        /// </summary>
            ...
            if (level == 3)
            {
                ...
                for (int i = 0; i < Map3.GetLength(0); i++)
                {
                    for (int j = 0; j < Map3.GetLength(1); j++)
                    {
                        if (Map3[i, j] == "p")
                        {
                            player = new Sprite2D(new Vector2(32, 32), new Vector2(20, 20), playerRef, "Player");
                        }
        ...
        int times;
        /// <summary>
        /// Przesuwanie gracza, kolizja, przejscie na kolejny poziom
        /// </summary>
        ...
        /// <summary>
        /// Poruszanie sie za pomoca strzalek
        /// </summary>
        /// <param name="e"></param>
